# ---
# title: Per Study Analysis Without SC1
...
svg(filename=paste(FIGURES_DIR,"H1N1_Model_Intersections_(Bar_Graph)_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
...
svg(filename=paste(FIGURES_DIR,"H3N2_Model_Intersections_(Bar_Graph)_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
plot(res, Layout="landscape",degree=2:4, sort.by="p-value")
...
svg(filename=paste(FIGURES_DIR,"Rhinovirus_Model_Intersections_(Bar_Graph)_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
plot(res, Layout="landscape",degree=2:4, sort.by="p-value")
...
H1N1_predictors %>%
  write(paste(GENELIST_DIR,"H1N1_Predictors_WithoutSC1.txt",sep=""))
svg(filename=paste(FIGURES_DIR,"H1N1_Predictor_PA_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
H1N1_predictors %>%
...
H3N2_predictors %>%
  write(paste(GENELIST_DIR,"H3N2_Predictors_WithoutSC1.txt",sep=""))
svg(filename=paste(FIGURES_DIR,"H3N2_Predictor_PA_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
H3N2_predictors %>%
...
Rhinovirus_predictors %>%
  write(paste(GENELIST_DIR,"Rhinovirus_Predictors_WithoutSC1.txt",sep=""))
svg(filename=paste(FIGURES_DIR,"Rhinovirus_Predictor_PA_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
Rhinovirus_predictors %>%
...
## H1N1 H3N2
svg(filename=paste(FIGURES_DIR,"H1N1_H3N2_Predictor_PA_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
H1N1_H3N2_predictors %>%
...
## H3N2 Rhinovirus
svg(filename=paste(FIGURES_DIR,"H3N2_Rhinovirus_Predictor_PA_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
H3N2_Rhinovirus_predictors %>%
...
## H1N1 Rhinovirus
svg(filename=paste(FIGURES_DIR,"H1N1_Rhinovirus_Predictor_PA_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
H1N1_Rhinovirus_predictors %>%
...
svg(filename=paste(FIGURES_DIR,"H1N1_H3N2_Rhinovirus_Predictor_PA_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
H1N1_H3N2_Rhinovirus_predictors %>% 
...
## H1N1 only
svg(filename=paste(FIGURES_DIR,"H1N1-Only_Predictor_PA_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
H1N1_Only %>%
...
## H3N2 only
svg(filename=paste(FIGURES_DIR,"H3N2-Only_Predictor_PA_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
H3N2_Only %>%
...
## Rhinovirus only
svg(filename=paste(FIGURES_DIR,"Rhinovirus-Only_Predictor_PA_WithoutSC1.svg",sep=""),
    width=15,
    height=15,
    pointsize=12)
Rhinovirus_Only %>%
